...
- **Native SVG Rasterization:** High-fidelity SVG to PNG conversion without external tools.
- **Built-in Image Compression:** Powered by `libcaesium`. Optimize JPEG/PNG quality and strip metadata locally.
- **High DPI / Retina Support:** Automatic @2x, @3x detection with generated Luau DPI-switching functions.
...
- **Choose Tungsten** for your primary workflow. It is the all-in-one solution for modern asset management, offering superior packing, SVG conversion, compression, and a developer-first experience.
