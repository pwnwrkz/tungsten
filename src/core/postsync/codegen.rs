...
fn generate_luau(
    ...
    line(&mut out, "-- This file was automatically @generated by Tungsten.");
...
fn write_entry_lines(entry: &CodegenEntry, key: &str, out: &mut String, depth: usize) {
    ...
    match &entry.kind {
        CodegenKind::Sprite {
            ...
            line(out, &format!("{}Image = {},", ind1, entry.asset_ref.luau_string()));
            line(
                out,
                &format!(
...
fn write_dts_entry_lines(entry: &CodegenEntry, key: &str, out: &mut String, depth: usize) {
    ...
    match &entry.kind {
        ...
        CodegenKind::DpiGroup { .. } => {
            line(out, &format!("{}{}: (dpiScale: number) => string", ind, key));
        }
    }
}
